...
$sql = "INSERT INTO freelancer(ID, Password, Name, Phone, Age, Major, Career, Proficiency)
VALUES('{$member_id}','{$member_pw}','{$member_name}','{$member_hp}','{$member_age}','{$member_major}','{$member_career}','{$member_pl}')";
